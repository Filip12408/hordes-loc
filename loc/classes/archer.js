export default {
  ...
  description: {
    ...
    sr: 'Стрелци су изузетно способни да концентришу своју моћ на једну мету и могу да делују на више противника делимично.Добар стрелац увек ће држати дистанцу и пуцати неприљатеље из далека.',
